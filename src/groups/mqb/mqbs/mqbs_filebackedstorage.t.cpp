...
class MockDataStore : public BloombergLP::mqbs::DataStore {
  ...
  public:
    ...
    void loadMessageRecordRaw(
        BloombergLP::mqbs::MessageRecord*,
        const BloombergLP::mqbs::DataStoreRecordHandle &) const
    {
    }
    void loadConfirmRecordRaw(
        BloombergLP::mqbs::ConfirmRecord*,
        const BloombergLP::mqbs::DataStoreRecordHandle &) const
    {
    }
    ...
    void loadQueueOpRecordRaw(
        BloombergLP::mqbs::QueueOpRecord*,
        const BloombergLP::mqbs::DataStoreRecordHandle &) const
    {
    }
    unsigned int
